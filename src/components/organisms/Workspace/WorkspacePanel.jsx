import { AlertTriangleIcon, Loader, MessageSquareTextIcon,HashIcon,SendHorizonalIcon } from 'lucide-react';
...
export const WorkspacePanel = () => {
    ...
    return (
        <div
            className="flex flex-col h-full bg-slate-900/80 border-r border-slate-800"
        >
